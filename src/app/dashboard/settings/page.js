  ...
  function renderTabButton(tab) {
    ...
    return (
      <button key={tab.id} onClick={() => setActiveTab(tab.id)}
        className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-xl transition-all shrink-0 ${
          activeTab === tab.id
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-gray-950 dark:to-gray-900">
      <div className="p-5 md:p-7 lg:p-10 max-w-5xl mx-auto">
        ...
        {/* Tabs */}
        <div 
          className="flex overflow-x-auto md:flex-wrap gap-2 pb-2 md:pb-0 mb-6 scrollbar-none"
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <label className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium rounded-xl border border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-all w-full sm:w-auto">
                      <ImageIcon className="w-4 h-4 text-gray-500" />
                      Upload Signature
                      <input type="file" accept="image/*" className="hidden" />
                    </label>
                    <button className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium rounded-xl border border-gray-200 dark:border-gray-700 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 transition-all w-full sm:w-auto">
                      <ImageIcon className="w-4 h-4 text-gray-500" />
                      Upload Stamp
                    </button>
                  </div>
              ...
              <div className="p-6">
                {(settings.treatments?.custom || []).length === 0 ? (
                  ...
                  <div className="space-y-3">
                    <div className="hidden md:grid grid-cols-[1fr_100px_120px_36px] gap-2 text-xs font-semibold text-gray-400 uppercase tracking-wider px-1">
                      <span>Name</span>
                      <span>Fee (&#x20B9;)</span>
                      <span>Category</span>
                      <span />
                    ...
                    {(settings.treatments?.custom || []).map((ct, i) => (
                      <div key={ct.id} className="flex flex-col md:grid md:grid-cols-[1fr_100px_120px_36px] gap-2 p-3 md:p-0 rounded-2xl border border-gray-100 dark:border-gray-800 md:border-none">
                        <input
                          value={ct.name}
                        ...
                        />
                        <div className="flex md:contents gap-2 items-center">
                          ...
                          <select
                            ...
                            className="flex-1 md:w-full px-2 py-1.5 text-xs rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/40"
                          >
                            {CATEGORIES.map(c => (
                        ...
                        {isEditing && (
                          <div className="px-4 py-3 space-y-2">
                            {tpl.medicines.map((med, mi) => (
                              <div key={mi} className="flex flex-col sm:flex-row sm:items-center gap-1.5 p-2.5 sm:p-0 rounded-xl border border-gray-100 dark:border-gray-800/80 sm:border-none">
                                <input type="text" value={med.name} onChange={e => updateTemplateMedicine(tpl.id, mi, 'name', e.target.value)}
                                  placeholder="Medicine" className="w-full sm:w-28 px-2 py-1 text-xs rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-violet-500/40 placeholder-gray-400" />
                                <div className="flex gap-1.5 items-center flex-wrap sm:flex-nowrap w-full sm:w-auto">
                                  ...
                                  <select value={med.frequency} onChange={e => updateTemplateMedicine(tpl.id, mi, 'frequency', e.target.value)}
                                    className="w-20 sm:w-14 px-1 py-1 text-xs rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-violet-500/40">
                                  ...
                                  <select value={med.duration} onChange={e => updateTemplateMedicine(tpl.id, mi, 'duration', e.target.value)}
                                    className="w-16 sm:w-14 px-1 py-1 text-xs rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-violet-500/40">
                                  ...
                                  <button onClick={() => removeTemplateMedicine(tpl.id, mi)}
                                    className="p-1 rounded text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 transition-all shrink-0">
