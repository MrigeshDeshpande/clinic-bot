    ...
    if (dateFrom && dateTo) {
      const rows = await sql`
        SELECT a.id, a.logical_id, a.wa_id,
               ...
               a.follow_up_date, a.follow_up_instructions, a.follow_up_status, a.follow_up_reason, a.follow_up_created_by,
    ...
    if (id) {
      const rows = await sql`
        SELECT a.id, a.logical_id, a.wa_id,
         ...
         a.status, a.arrival_status, a.arrived_at, a.called_at, a.is_priority,
               a.consultation_fee, a.treatment_charges, a.medicine_charges,
               a.diagnosis, a.medicines, a.notes, a.follow_up_date, a.follow_up_instructions, a.follow_up_status, a.follow_up_reason, a.follow_up_created_by,
               (a.follow_up_date - CURRENT_DATE)::int AS followup_days_remaining,
