export const GLOBAL_INTENTS = {
  ...
  affirm:    ['ok','okay','sure','right','fine','good','yep','yeah','alright','that works','perfect','great','got it','cool','done with this'],
...
export const STATE_INTENTS = {
  ...
  BOOKING_CONFIRMATION: { confirm:    ['confirm','correct','book it','done','proceed','yes','go ahead','book'],
