  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-1.5">
        ...
        {!showRxTemplateInput ? (
          <button type="button" onClick={() => setShowRxTemplateInput(true)} disabled={form.medicines.length === 0 && form.adviceSelected.length === 0}
            ...
            <Plus className="w-3 h-3 inline mr-0.5" /> Save preset
          </button>
        ) : (
      ...
      <button type="button" onClick={addMedicine}
        className="inline-flex items-center gap-1 text-[10px] font-medium text-violet-500 dark:text-violet-400 hover:text-violet-600 transition-colors">
