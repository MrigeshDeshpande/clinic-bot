...
function rowToSession(row) {
  ...
  const session = {
    ...
    context: {
      ...
      // Dynamic context fields — preserved on DB reload
      awaitingTreatmentHelp: contextRaw.awaitingTreatmentHelp || null,
      doctorDate: contextRaw.doctorDate || null,
      doctorScheduleAction: contextRaw.doctorScheduleAction || null,
      editField: contextRaw.editField || null,
      familyPatients: Array.isArray(contextRaw.familyPatients) ? contextRaw.familyPatients : null,
      language: contextRaw.language || null,
      logVisitPending: contextRaw.logVisitPending === true,
      logVisitSearch: contextRaw.logVisitSearch || null,
      multiTreatmentActive: contextRaw.multiTreatmentActive === true,
      patientProfile: contextRaw.patientProfile || null,
      pendingBlockDate: contextRaw.pendingBlockDate || null,
      pendingBlockCount: contextRaw.pendingBlockCount || null,
      pendingMedia: contextRaw.pendingMedia || null,
      pendingMediaQuery: contextRaw.pendingMediaQuery || null,
      pendingTranscription: contextRaw.pendingTranscription || null,
      quickVisitApptId: contextRaw.quickVisitApptId || null,
      quickVisitPatient: contextRaw.quickVisitPatient || null,
      registration: contextRaw.registration || null,
      returnToState: contextRaw.returnToState || null,
      role: contextRaw.role || null,
      searchResults: Array.isArray(contextRaw.searchResults) ? contextRaw.searchResults : null,
      selectedAppointment: contextRaw.selectedAppointment || null,
      selectedAppointmentId: contextRaw.selectedAppointmentId || null,
      selectedPatient: contextRaw.selectedPatient || null,
      selectedPatientId: contextRaw.selectedPatientId || null,
      selectedQueueAppointmentId: contextRaw.selectedQueueAppointmentId || null,
      visitLog: contextRaw.visitLog || null,
      walkin: contextRaw.walkin || null,
    },
    metrics: {
